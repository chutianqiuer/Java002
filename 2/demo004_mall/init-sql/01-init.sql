...
-- Seata undo_log table for mall_product
...
-- Seata undo_log table for mall_order
CREATE TABLE IF NOT EXISTS undo_log (
    id BIGINT NOT NULL AUTO_INCREMENT,
    branch_id BIGINT NOT NULL,
    xid VARCHAR(100) NOT NULL,
...
-- Note: Seata Server is using file mode, so global_table/branch_table/lock_table are not needed here
